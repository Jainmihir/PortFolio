...
export const Technologies = [{
    name: "Jekyll",
    Icon: Icons.SiJekyll,
    description: "A simple, blog-aware, static site generator for personal, project, or organization sites. Written in Ruby by Tom Preston-Werner, GitHub's co-founder, it is distributed under the open source MIT license",
...
},
{
    ...
    description: "A free and open-source content management system written in PHP and paired with a MySQL or MariaDB database. Features include a plugin architecture and a template system, referred to within WordPress as Themes",
...
},
{
    ...
    description: "A secure cloud services platform, offering compute power, database storage, content delivery and other functionality",
...
},
{
    name: "Deno",
    Icon: Icons.SiDeno,
    description: "A simple, modern and secure runtime for JavaScript and TypeScript that uses V8 and is built in Rust",
    url: "https://deno.land",
    primaryColor: "var(--text-color)",
},
{
    ...
    description: "A natural language understanding platform that makes it easy to design and integrate a conversational user interface into your mobile app, web application, device, bot, interactive voice response system, and so on",
...
{
    name: "GithubActions",
    description: "GitHub Actions helps you build, test, and deploy applications, but you can also use it to automate other tasks common to your developer workflows",
...
{
    name: "Gitlab",
    description: "A web-based DevOps lifecycle tool that provides a Git-repository manager providing wiki, issue-tracking and continuous integration and deployment pipeline features",
    Icon: Icons.SiGitlab,
...
{
    name: "Gnome",
    description: "A free and open-source desktop environment for Unix-like operating systems",
    Icon: Icons.SiGnome,
...
{
    name: "JavaScript",
    description: "A fun and flexible programming language and one of the core technologies of web development and can be used on both the front-end and the back-end",
...
{
    name: "Netlify",
    description: "A cloud computing company that offers hosting and serverless backend services for web applications and static websites",
...
{
    name: "NextJS",
    description: "An open-source React front-end development web framework created by Vercel that enables functionality such as server-side rendering and generating static websites for React based web applications",
...
{
    name: "Svelte",
    description: "A new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM",
    Icon: Icons.SiSvelte,
...
{
    name: "Ubuntu",
    description: "The modern, open source operating system on Linux for the enterprise server, desktop, cloud, and IoT",
    Icon: Icons.SiUbuntu,
...
{
    name: "WebAssembly",
    description: "A binary instruction format for a stack-based virtual machine, designed as a portable compilation target for programming languages, enabling deployment on the web for client and server applications",
...
{
    name: "WireGuard",
    description: "A general purpose VPN for running on embedded interfaces and super computers alike, fit for many different circumstances",
...
{
    name: "Razorpay",
    description: "Razorpay is an online payment system that can access all your credit, debit cards, UPI, and popular mobile wallets. It makes nuisance-free payments in India for others",
    Icon: Icons.SiRazorpay,
    url: "https://razorpay.com/",
    primaryColor: "#0b72e7"
},
{
    name: "TailwindCSS",
    description: "An open source CSS framework. It does not provide a series of predefined classes for elements such as buttons or tables.",
...
},
{
    ...
    Icon: Icons.SiTerraform,
    url: "https://www.terraform.io/",
    primaryColor: "#7b42bc"
},
{
    name: "CPlusPlus",
    description: "C++ is a robust and versatile programming language widely used across diverse domains, known for its performance and flexibility in developing efficient software solutions.",
